...
class XYZTranslatorMixin():
    ...
    def xyz_translator(self, tx_array: handybeam_core.tx_array.TxArray,
                        x_focus,y_focus,z_focus,x_translate,y_translate,
                        z_translate,local_work_size = (1,1,1),print_performance_feedback = False):

        '''
        ---------------------------------------------
        xyz_translator(tx_array, x_translate,y_translate,plane_height, local_work_size, print_performance_feedback)
        ---------------------------------------------
        ...
        tx_array : handybeam_core.tx_array.TxArray
