...
import numpy as np
import handybeam_core.bugcatcher
...
class World():
    ...
    def __init__(self,frequency = 40000,sound_velocity = 343):
        ...
        self.samplers = []
        self.tx_array = handybeam_core.tx_array_library.USX(parent = self)
        self.propagator =  handybeam_core.opencl_wrappers.propagator_wrappers.Propagator(parent=self) 
