...
class EvaluatorTests(unittest.TestCase):
    ...
    def test_import(self):
        ...
        module_name = 'handybeam.evaluators'
    ...
    def test_instance_creation(self):
        ...
        evaluator_3d = handybeam.evaluators.Evaluator3D()

        if isinstance(evaluator_2d, handybeam.evaluators.Evaluator2D) and \
           isinstance(evaluator_3d, handybeam.evaluators.Evaluator3D):
    ...
    def test_2d_metrics(self):
        ...
        import handybeam.evaluators
        import numpy as np
        from handybeam.test_code.beam_metrics_2d import TestSamplingField
    ...
    def test_3d_metrics(self):
        ...
        import handybeam.evaluators
        import numpy as np
        from handybeam.test_code.beam_metrics_3d import TestSamplingField
